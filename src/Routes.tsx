...
const FeaturedArticles = React.lazy(() => import("pages/ArticlesFeatured"));
const LatestArticles = React.lazy(() => import("pages/ArticlesLatest"));
      ...
      <Router>
        <Routes>
          ...
          <Route path="/" element={<Layout />}>
            ...
            <Route path="/articles/latest" element={<LatestArticles />} />
