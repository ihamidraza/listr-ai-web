      ...
      <div className="bg-gray-900 flex flex-col font-plusjakartasans items-center justify-start mx-auto w-full">
        <div className="flex flex-col justify-start w-full">
          <div className="flex flex-col md:px-5 relative w-full">
            ...
            <header className="bg-black-900_33 flex md:flex-col flex-row md:gap-5 items-center justify-center mt-[-NaNpx] mx-auto shadow-bs w-full z-[1]">
              <Text
              ...
              <div className="flex md:flex-1 flex-col gap-[9px] items-center justify-start mb-[35px] md:ml-[0] ml-[30px] md:mt-0 mt-[46px] w-[11%] md:w-full">
                <Text
