...
const FavoritesPageLoginPage: React.FC = () => {
  return (
    <>
      <div className="bg-gray-900 flex flex-col font-plusjakartasans mx-auto pb-[59px] relative w-full">
        <div className="h-[1410px] sm:h-[808px] md:h-[894px] mx-auto md:px-5 w-full">
          <div
          ...
          >
            <div className="flex flex-col items-center justify-start mb-[52px] w-[90%] md:w-full">
              ...
              <div className="flex flex-col gap-[38px] items-center justify-start mt-[73px] w-full">
                <Line className="bg-gradient3  h-px w-full" />
                <div className="bg-black-900_33 border border-blue_gray-900 border-solid flex flex-row gap-[84px] items-center justify-center p-[15px] rounded-[15px] w-[29%] md:w-full">
                  <Button
              ...
              <div className="flex flex-col items-center justify-start mt-[47px] w-[22%] md:w-full">
                <Button
                  className="!text-amber-500 border border-blue_gray-900 border-solid cursor-pointer font-semibold min-w-[257px] rounded-[24px] text-center text-sm"
                  color="black_900_33"
                  size="xl"
                  variant="fill"
                >
                  Its Free & Takes Only 60 Sec
                </Button>
              </div>
              <Button
                className="cursor-pointer flex items-center justify-center min-w-[158px] mt-[47px] rounded-[27px]"
                leftIcon={
                  <Img
        ...
        <div className="h-[422px] md:h-[NaNpx] max-w-[1212px] mb-[258px] mt-[-NaNpx] mx-auto md:px-5 w-full z-[1]">
        ...
        <div className="flex flex-col items-center justify-start max-w-[1217px] mt-[-22.48px] mx-auto md:px-5 w-full z-[1]">
...
export default FavoritesPageLoginPage;
