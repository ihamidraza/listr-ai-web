...
const BookmarkWebsitLinkpagePage: React.FC = () => {
  return (
    <>
        ...
        <div className="flex flex-col gap-[55px] items-center justify-start w-full">
          ...
          <div className="flex flex-col items-center justify-start max-w-[1217px] mx-auto md:px-5 w-full">
            ...
            <div className="flex md:flex-col flex-row md:gap-[46px] items-start justify-between mt-[45px] w-full">
              <div className="bg-white-A700_0a border border-blue_gray-900 border-solid flex md:flex-1 flex-col items-center justify-center mb-[292px] md:mt-0 mt-[79px] p-[17px] rounded-[15px] w-[28%] md:w-full">
                <div className="flex flex-col gap-[9px] items-center justify-start mt-[7px] w-[58%] md:w-full">
                  <Text
                    className="md:text-2xl sm:text-[22px] text-[26px] text-white-A700"
                  ...
                  <RatingBar
                    className="flex justify-between rounded-[1px] w-[170px]"
                    value={1}
                    starCount={5}
                    color="#ffc107"
                    activeColor="#d9d9d9"
                ...
                <Input
                  ...
                  wrapClassName="border border-blue_gray-900 border-solid mt-[15px] rounded-[15px] w-full"
                  color="black_900_19"
                  size="md"
                  variant="fill"
                ></Input>
                <div className="flex h-[58px] md:h-[90px] justify-end mb-[7px] mt-[25px] relative w-[68%]">
                  <div className="backdrop-opacity-[0.5] bg-amber-500 blur-[24.00px] h-8 mb-[3px] ml-auto mr-[57px] mt-auto rounded-[50%] w-8"></div>
                  <Button
                    className="absolute border border-amber-500 border-solid cursor-pointer font-semibold h-full inset-[0] m-auto min-w-[200px] rounded-[7px] text-center text-lg uppercase"
                    color="amber_500_19"
                    size="xl"
                    variant="fill"
                  >
...
export default BookmarkWebsitLinkpagePage;
