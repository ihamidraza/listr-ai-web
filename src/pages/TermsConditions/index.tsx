            ...
            <div className="h-[813px] m-auto w-full">
              ...
              <div className="absolute h-[813px] inset-[0] justify-center m-auto w-full">
                ...
                <div className="absolute bottom-[4%] flex flex-col inset-x-[0] items-center justify-center mx-auto">
                  ...
                  >
                    <>
                      Welcome to Listaraitool!
                      <br />
                      These terms and conditions outline the rules and
                      regulations for the use of Codify Solution&#39;s Website,
                      located at https://Listaraitool.com.
                      <br />
                      By accessing this website we assume you accept these terms
                      and conditions. Do not continue to use Listaraitool if you
