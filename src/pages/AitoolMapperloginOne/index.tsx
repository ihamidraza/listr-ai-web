...
const AitoolMapperloginOnePage: React.FC = () => {
  return (
    <>
            ...
            <div className="h-[813px] m-auto w-full">
              ...
              <div className="absolute h-[813px] inset-[0] justify-center m-auto w-full">
                <Img
                  ...
                  alt="image"
                />
                <div className="absolute bottom-[1%] flex flex-col gap-[50px] inset-x-[0] items-start justify-start mx-auto w-[84%]">
                  <div className="flex flex-col items-center justify-start w-full">
                    <div className="flex flex-col items-center justify-end w-full">
                      <div className="flex flex-col items-start justify-end w-full">
                        <div className="flex sm:flex-col flex-row gap-5 items-center justify-start w-1/2 md:w-full">
                          <Img
                        ...
                        <div className="flex flex-row gap-2.5 items-center justify-end md:ml-[0] ml-[892px] mt-[26px] w-[26%] md:w-full">
                          <Button
                            className="border border-blue_gray-900 border-solid cursor-pointer min-w-[246px] text-center text-sm"
                            shape="round"
                            color="black_900_33"
                            size="2xl"
                            variant="fill"
                        ...
                        <div className="flex md:flex-col flex-row gap-5 items-start justify-between mt-[30px] w-full">
                          <Img
                            className="h-[50px] md:h-auto rounded-[50%] w-[50px]"
                            src="images/img_ellipse29.png"
                            alt="ellipseThirtyOne"
                          />
                          <div className="bg-black-900_33 border border-blue_gray-900 border-solid flex flex-col items-center justify-start p-5 rounded-[15px]">
                            <Text
                              className="leading-[22.00px] mb-[7px] mt-0.5 text-sm text-white-A700 w-full"
                            ...
                            >
                              <>
                                ...
                                including versions of Lorem Ipsum.Lorem Ipsum is
                  ...
                  <div className="flex flex-row gap-[15px] items-center justify-start w-[27%] md:w-full">
                    <div className="bg-black-900_33 border border-blue_gray-900 border-solid flex flex-col items-center justify-end p-3 rounded-[24px]">
                      <Text
                    ...
                    <div className="bg-black-900_33 border border-blue_gray-900 border-solid flex flex-col items-center justify-end p-3.5 rounded-[24px]">
                      <Text
...
export default AitoolMapperloginOnePage;
