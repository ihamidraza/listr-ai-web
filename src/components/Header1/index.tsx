...
export const Header1: React.FC<Header1Props> = (props) => {
  return (
    <>
      <header className={props.className}>
        ...
        <div className="flex flex-col gap-[7px] items-center justify-start mb-[35px] md:ml-[0] ml-[30px] md:mt-0 mt-12 w-[9%] md:w-full">
          <Text
