...
export const Header3: React.FC<Header3Props> = (props) => {
  return (
    <>
      <header className={props.className}>
        ...
        <div className="flex flex-col gap-1.5 items-center justify-start mb-9 md:ml-[0] ml-[30px] md:mt-0 mt-[52px] w-[10%] md:w-full">
          <Text
